        ...
        type: [
            {
                ...
                venueSize: { type: String, required: true },
...
export type ExperientialEventDocument = HydratedDocument<ExperientialEvent>;
export const ExperientialEventSchema = SchemaFactory.createForClass(ExperientialEvent);


ExperientialEventSchema.index({
    title: "text",
    tags: "text",
    description: "text"
});
ExperientialEventSchema.index({ title: 1 });
ExperientialEventSchema.index({ tags: 1 });
ExperientialEventSchema.index({ "city.name": 1 });
// Plugins
