...
export class BirthdayEvent {
    ...
    // venueSizes: { min: number; max: number };
...
export type BirthdayEventDocument = HydratedDocument<BirthdayEvent>;

export const BirthdayEventSchema = SchemaFactory.createForClass(BirthdayEvent);
// 🔥 COMPOUND INDEX FOR MAIN FILTER
BirthdayEventSchema.index({
    active: 1,
    isDeleted: 1,
    ageGroup: 1,
    "city.name": 1
