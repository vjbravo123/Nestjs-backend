...
export class Payment {
  ...
  /** Original total amount before partial/discount calculation */
  @Prop()
  totalAmount?: number;

  /** Payment option chosen: MINIMUM | CUSTOM | FULL */
  @Prop({ enum: ['MINIMUM', 'CUSTOM', 'FULL', 'OFFLINE'] })
  paymentOption?: string;

  /** Percentage of totalAmount being paid */
  @Prop()
  payPercent?: number;

  /** Online discount amount applied */
  @Prop({ default: 0 })
  onlineDiscountApplied?: number;

  /** Full bonus discount amount applied */
  @Prop({ default: 0 })
  fullBonusApplied?: number;
  ...
  @Prop({ enum: ['phonepe', 'razorpay', 'stripe', 'offline'], default: 'phonepe' })
  gateway: string;
